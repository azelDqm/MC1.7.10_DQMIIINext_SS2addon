...
public class DqmArmorSetEvent extends Event{
	...
	public DqmArmorSetEvent (EntityPlayer ep, int[] status, ArmorMaterial[] equips, ArmorMaterial[] material, int enableCnt)
	{
		this.player = ep;
		this.status = status;
		this.equips = equips;
